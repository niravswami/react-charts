...
export default function Recharts() {
	const data = [
		...
		{ name: "Page B", uv: 500, pv: 2600, amt: 2500 },
		{ name: "Page C", uv: 300, pv: 2700, amt: 2500 },
		{ name: "Page D", uv: 200, pv: 2800, amt: 2500 },
		{ name: "Page E", uv: 630, pv: 2900, amt: 2500 },
	];
	...
	return (
		<>
			<div className="flex justify-center items-center">
				<span className="text-2xl mb-4">Recharts charts</span>
			</div>
